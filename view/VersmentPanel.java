...
public class VersmentPanel extends JPanel {
        ...
        SwingWorker<Void, Void> worker = new SwingWorker<>() {
            ...
            protected Void doInBackground() {
                ...
                SwingUtilities.invokeLater(() -> {
                    totalLabel.setText("Total: " + total.toString() + " DA");
                });
    ...
    private void showAddDialog() {
        VersmentDialog dialog = new VersmentDialog((JFrame) SwingUtilities.getWindowAncestor(this), "Ajouter Versement", null);
    ...
    private void showEditDialog() {
        ...
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(this, "Veuillez sélectionner un versement", "Avertissement", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        if (versmentToEdit != null) {
            VersmentDialog dialog = new VersmentDialog((JFrame) SwingUtilities.getWindowAncestor(this), "Modifier Versement", versmentToEdit);
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
